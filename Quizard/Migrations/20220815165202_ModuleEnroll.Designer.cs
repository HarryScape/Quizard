...
namespace Quizard.Migrations
{
    ...
    [Migration("20220815165202_ModuleEnroll")]
    partial class ModuleEnroll
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModuleUser", b =>
                {
                    b.Property<string>("ModuleUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("UserModulesId")
                        .HasColumnType("int");

                    b.HasKey("ModuleUsersId", "UserModulesId");
            ...
            modelBuilder.Entity("ModuleUser", b =>
                {
                    b.HasOne("Quizard.Models.User", null)
                        .WithMany()
                        .HasForeignKey("ModuleUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Quizard.Models.Module", null)
                        .WithMany()
